      ...
      <nav className="sticky top-0 z-40 border-b border-border/70 bg-background/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <Link className={cn(buttonVariants({ variant: "ghost", size: "sm" }), "hidden sm:inline-flex")} href="/signin">Sign in</Link>
            <Link className={cn(buttonVariants({ size: "sm" }), "inline-flex w-fit items-center justify-center gap-2 whitespace-nowrap")} href="/signin">Start building <ArrowRight className="h-4 w-4 shrink-0" data-icon="inline-end" /></Link>
          </div>
        </div>
      </nav>
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1fr_.9fr] lg:gap-20">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link className={cn(buttonVariants({ size: "lg" }), "inline-flex w-fit items-center justify-center gap-2 whitespace-nowrap")} href="/signin">Build your portfolio <ArrowRight className="h-4 w-4 shrink-0" data-icon="inline-end" /></Link>
